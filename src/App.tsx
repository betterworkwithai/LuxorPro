...
/**
 * /login — explicit "sign in" entry from the marketing page.
 * Clears any stale session so the user always sees the login form
 * instead of bouncing to the subscription gate when their cached
 * profile lacks an active plan.
 */
function LoginEntry() {
